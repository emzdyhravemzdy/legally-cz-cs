...
namespace LegallyCz.Tests.Factories;

public class FactoryTaxingTest : LegallyCzTestDataBaseTest
{
    private readonly IProviderFactory<IProviderTaxing, IPropsTaxing> _sut;
    public FactoryTaxingTest(ITestOutputHelper outputHelper) : base(outputHelper) 
    {
    ...
    public void GetProps_ShouldReturnValid_Version(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear)
    {
        ...
        var testResult = _sut.GetProps(serviceProvider, testPeriod);
