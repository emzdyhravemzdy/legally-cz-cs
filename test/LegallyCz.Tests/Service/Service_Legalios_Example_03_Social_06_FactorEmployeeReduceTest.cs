...
public class Service_LegallyCz_Example_03_Social_06_FactorEmployeeReduceTest : Service_LegallyCz_Example_SocialTest
{
    ...
    public Service_LegallyCz_Example_03_Social_06_FactorEmployeeReduceTest(ITestOutputHelper outputHelper) : base(outputHelper, "03_Social_06_FactorEmployeeReduce.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_03_Social_06_FactorEmployeeReduceTest>();
    ...
    public void GetBundle_ShouldReturnValid_FactorEmployeeReduce(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SocialProps.FactorEmployeeReduce.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
