...
public class Service_LegallyCz_Example_03_Social_03_FactorEmployerHigherTest : Service_LegallyCz_Example_SocialTest
{
    ...
    public Service_LegallyCz_Example_03_Social_03_FactorEmployerHigherTest(ITestOutputHelper outputHelper) : base(outputHelper, "03_Social_03_FactorEmployerHigher.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_03_Social_03_FactorEmployerHigherTest>();
    ...
    public void GetBundle_ShouldReturnValid_FactorEmployerHigher(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SocialProps.FactorEmployerHigher.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
