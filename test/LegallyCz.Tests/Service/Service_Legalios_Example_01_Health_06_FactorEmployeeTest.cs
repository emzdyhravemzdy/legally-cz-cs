...
public class Service_LegallyCz_Example_01_Health_06_FactorEmployeeTest : Service_LegallyCz_Example_HealthTest
{
    ...
    public Service_LegallyCz_Example_01_Health_06_FactorEmployeeTest(ITestOutputHelper outputHelper) : base(outputHelper, "01_Health_06_FactorEmployee.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_01_Health_06_FactorEmployeeTest>();
    ...
    public void GetBundle_ShouldReturnValid_FactorEmployee(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.HealthProps.FactorEmployee.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
