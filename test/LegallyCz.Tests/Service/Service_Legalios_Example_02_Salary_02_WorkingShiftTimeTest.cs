...
public class Service_LegallyCz_Example_02_Salary_02_WorkingShiftTimeTest : Service_LegallyCz_Example_SalaryTest
{
    ...
    public Service_LegallyCz_Example_02_Salary_02_WorkingShiftTimeTest(ITestOutputHelper outputHelper) : base(outputHelper, "02_Salary_02_WorkingShiftTime.txt")
    {
        _sut = service;
    }
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_02_Salary_02_WorkingShiftTimeTest>();
    ...
    public void GetBundle_ShouldReturnValid_WorkingShiftTime(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SalaryProps.WorkingShiftTime.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
