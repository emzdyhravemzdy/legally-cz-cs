...
public class Service_LegallyCz_Example_04_Taxing_19_MarginIncomeOfTaxRate2Test : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_19_MarginIncomeOfTaxRate2Test(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_19_MarginIncomeOfTaxRate2.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_19_MarginIncomeOfTaxRate2Test>();
    ...
    public void GetBundle_ShouldReturnValid_MarginIncomeOfSolidary(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.MarginIncomeOfTaxRate2.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
