...
public class Service_LegallyCz_Example_04_Taxing_13_MinAmountOfTaxBonusTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_13_MinAmountOfTaxBonusTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_13_MinAmountOfTaxBonus.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_13_MinAmountOfTaxBonusTest>();
    ...
    public void GetBundle_ShouldReturnValid_MinAmountOfTaxBonus(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.MinAmountOfTaxBonus.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
