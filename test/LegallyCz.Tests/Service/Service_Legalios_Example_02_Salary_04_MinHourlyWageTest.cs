...
public class Service_LegallyCz_Example_02_Salary_04_MinHourlyWageTest : Service_LegallyCz_Example_SalaryTest
{
    ...
    public Service_LegallyCz_Example_02_Salary_04_MinHourlyWageTest(ITestOutputHelper outputHelper) : base(outputHelper, "02_Salary_04_MinHourlyWage.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_02_Salary_04_MinHourlyWageTest>();
    ...
    public void GetBundle_ShouldReturnValid_MinHourlyWage(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SalaryProps.MinHourlyWage.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
