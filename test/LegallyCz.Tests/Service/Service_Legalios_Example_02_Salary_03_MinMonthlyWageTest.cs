...
public class Service_LegallyCz_Example_02_Salary_03_MinMonthlyWageTest : Service_LegallyCz_Example_SalaryTest
{
    ...
    public Service_LegallyCz_Example_02_Salary_03_MinMonthlyWageTest(ITestOutputHelper outputHelper) : base(outputHelper, "02_Salary_03_MinMonthlyWage.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_02_Salary_03_MinMonthlyWageTest>();
    ...
    public void GetBundle_ShouldReturnValid_MinMonthlyWage(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SalaryProps.MinMonthlyWage.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
