...
public class Service_LegallyCz_Example_01_Health_02_MaxAnnualsBasisTest : Service_LegallyCz_Example_HealthTest
{
    ...
    public Service_LegallyCz_Example_01_Health_02_MaxAnnualsBasisTest(ITestOutputHelper outputHelper) : base(outputHelper, "01_Health_02_MaxAnnualsBasis.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_01_Health_02_MaxAnnualsBasisTest>();
    ...
    public void GetBundle_ShouldReturnValid_MaxAnnualsBasis(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.HealthProps.MaxAnnualsBasis.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
