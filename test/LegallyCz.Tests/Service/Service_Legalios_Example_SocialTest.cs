...
public class Service_LegallyCz_Example_SocialTest : Service_LegallyCz_Example_BaseTest
{
    public Service_LegallyCz_Example_SocialTest(ITestOutputHelper outputHelper, string testSuiteFileName) : base(outputHelper, testSuiteFileName)
    {
    }
