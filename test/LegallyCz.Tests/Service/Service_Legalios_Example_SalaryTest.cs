...
public class Service_LegallyCz_Example_SalaryTest : Service_LegallyCz_Example_BaseTest
{
    public Service_LegallyCz_Example_SalaryTest(ITestOutputHelper outputHelper, string testSuiteFileName) : base(outputHelper, testSuiteFileName)
    {
    }
