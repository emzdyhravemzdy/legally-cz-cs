...
public class Service_LegallyCz_Example_03_Social_01_MaxAnnualsBasisTest : Service_LegallyCz_Example_SocialTest
{
    ...
    public Service_LegallyCz_Example_03_Social_01_MaxAnnualsBasisTest(ITestOutputHelper outputHelper) : base(outputHelper, "03_Social_01_MaxAnnualsBasis.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_03_Social_01_MaxAnnualsBasisTest>();
    ...
    public void GetBundle_ShouldReturnValid_MaxAnnualsBasis(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SocialProps.MaxAnnualsBasis.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
