...
public class Service_LegallyCz_Example_04_Taxing_15_MarginIncomeOfTaxBonusTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_15_MarginIncomeOfTaxBonusTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_15_MarginIncomeOfTaxBonus.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_15_MarginIncomeOfTaxBonusTest>();
    ...
    public void GetBundle_ShouldReturnValid_MarginIncomeOfTaxBonus(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.MarginIncomeOfTaxBonus.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
