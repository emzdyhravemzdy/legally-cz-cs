...
public class Service_LegallyCz_Example_04_Taxing_12_FactorTaxRate2Test : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_12_FactorTaxRate2Test(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_12_FactorTaxRate2.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_12_FactorTaxRate2Test>();
    ...
    public void GetBundle_ShouldReturnValid_FactorTaxRate2(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.FactorTaxRate2.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
