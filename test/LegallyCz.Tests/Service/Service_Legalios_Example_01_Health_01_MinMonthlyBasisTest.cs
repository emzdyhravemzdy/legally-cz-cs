...
public class Service_LegallyCz_Example_01_Health_01_MinMonthlyBasisTest : Service_LegallyCz_Example_HealthTest
{
    ...
    public Service_LegallyCz_Example_01_Health_01_MinMonthlyBasisTest(ITestOutputHelper outputHelper) : base(outputHelper, "01_Health_01_MinMonthlyBasis.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_01_Health_01_MinMonthlyBasisTest>();
    ...
    public void GetBundle_ShouldReturnValid_MinMonthlyBasis(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.HealthProps.MinMonthlyBasis.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
