...
public class Service_LegallyCz_Example_04_Taxing_02_AllowanceDisability1stTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_02_AllowanceDisability1stTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_02_AllowanceDisability1st.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_02_AllowanceDisability1stTest>();
        LogTestExamples(testLogger, _tests);
        Assert.True(true);
    }
    [Theory]
    [MemberData(nameof(TestData))]
    public void GetBundle_ShouldReturnValid_AllowanceDisability1st(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.AllowanceDisability1st.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
