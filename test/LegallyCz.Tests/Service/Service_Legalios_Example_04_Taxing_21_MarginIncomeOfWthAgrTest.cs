...
public class Service_LegallyCz_Example_04_Taxing_21_MarginIncomeOfWthAgrTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_21_MarginIncomeOfWthAgrTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_21_MarginIncomeOfWthAgr.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_21_MarginIncomeOfWthAgrTest>();
    ...
    public void GetBundle_ShouldReturnValid_MarginIncomeOfWthAgr(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.MarginIncomeOfWthAgr.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
