...
public class Service_LegallyCz_Example_03_Social_05_FactorEmployeeGarantTest : Service_LegallyCz_Example_SocialTest
{
    ...
    public Service_LegallyCz_Example_03_Social_05_FactorEmployeeGarantTest(ITestOutputHelper outputHelper) : base(outputHelper, "03_Social_05_FactorEmployeeGarant.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_03_Social_05_FactorEmployeeGarantTest>();
    ...
    public void GetBundle_ShouldReturnValid_FactorEmployeeGarant(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.SocialProps.FactorEmployeeGarant.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
