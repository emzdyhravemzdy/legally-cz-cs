...
public class Service_LegallyCz_Example_04_Taxing_10_FactorWithholdTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_10_FactorWithholdTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_10_FactorWithhold.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_10_FactorWithholdTest>();
    ...
    public void GetBundle_ShouldReturnValid_FactorWithhold(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.FactorWithhold.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
