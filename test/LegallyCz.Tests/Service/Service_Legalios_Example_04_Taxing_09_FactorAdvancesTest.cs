...
public class Service_LegallyCz_Example_04_Taxing_09_FactorAdvancesTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_09_FactorAdvancesTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_09_FactorAdvances.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_09_FactorAdvancesTest>();
    ...
    public void GetBundle_ShouldReturnValid_FactorAdvances(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Decimal resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.FactorAdvances.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
