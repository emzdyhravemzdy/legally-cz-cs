...
public class Service_LegallyCz_Example_04_Taxing_20_MarginIncomeOfWthEmpTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_20_MarginIncomeOfWthEmpTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_20_MarginIncomeOfWthEmp.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_20_MarginIncomeOfWthEmpTest>();
    ...
    public void GetBundle_ShouldReturnValid_MarginIncomeOfWthEmp(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.MarginIncomeOfWthEmp.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
