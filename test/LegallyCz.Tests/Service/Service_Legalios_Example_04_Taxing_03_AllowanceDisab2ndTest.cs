...
public class Service_LegallyCz_Example_04_Taxing_03_AllowanceDisability2ndTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_03_AllowanceDisability2ndTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_03_AllowanceDisability2nd.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_03_AllowanceDisability2ndTest>();
        LogTestExamples(testLogger, _tests);
        Assert.True(true);
    }
    [Theory]
    [MemberData(nameof(TestData))]
    public void GetBundle_ShouldReturnValid_AllowanceDisability2nd(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.AllowanceDisability2nd.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
