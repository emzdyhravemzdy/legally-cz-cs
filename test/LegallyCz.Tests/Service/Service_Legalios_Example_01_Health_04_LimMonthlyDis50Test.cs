...
public class Service_LegallyCz_Example_01_Health_04_LimMonthlyDis50Test : Service_LegallyCz_Example_HealthTest
{
    ...
    public Service_LegallyCz_Example_01_Health_04_LimMonthlyDis50Test(ITestOutputHelper outputHelper) : base(outputHelper, "01_Health_04_LimMonthlyDis50.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_01_Health_04_LimMonthlyDis50Test>();
    ...
    public void GetBundle_ShouldReturnValid_LimMonthlyDis50(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.HealthProps.LimMonthlyDis50.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
