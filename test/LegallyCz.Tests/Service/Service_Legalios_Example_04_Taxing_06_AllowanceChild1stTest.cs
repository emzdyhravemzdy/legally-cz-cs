...
public class Service_LegallyCz_Example_04_Taxing_06_AllowanceChild1stTest : Service_LegallyCz_Example_TaxingTest
{
    ...
    public Service_LegallyCz_Example_04_Taxing_06_AllowanceChild1stTest(ITestOutputHelper outputHelper) : base(outputHelper, "04_Taxing_06_AllowanceChild1st.txt")
    {
        _sut = service;
    }
    [Fact]
    ...
    {
        var testLogger = CreateLoggerFile<Service_LegallyCz_Example_04_Taxing_06_AllowanceChild1stTest>();
    ...
    public void GetBundle_ShouldReturnValid_AllowanceChild1st(string testTitle, string testName, Int16 testYear, Int16 testMonth, Int16 resultYear, Int16 resultMonth, Int32 resultValue)
    {
        ...
        testResult.MatchSucc(r => r.TaxingProps.AllowanceChild1st.Should().Be(resultValue, "Because Period: {0} - {1}", testTitle, testName));
    }
}
