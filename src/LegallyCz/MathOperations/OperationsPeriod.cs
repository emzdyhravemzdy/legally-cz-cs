...
namespace HraveMzdy.LegallyCz.MathOperations;
...
public static class OperationsPeriod
{
    ...
    public static Int16 DaysInMonth(ILegallyPeriod period)
    {
        return (Int16)DateTime.DaysInMonth(period.Year, period.Month);
    }
    public static DateTime DateOfMonth(ILegallyPeriod period, Int16 dayOrdinal)
    {
    ...
    public static int WeekDayOfMonth(ILegallyPeriod period, Int16 dayOrdinal)
    {
    ...
    public static Byte DateFromInPeriod(ILegallyPeriod period, DateTime? dateFrom)
    {
    ...
    public static Byte DateStopInPeriod(ILegallyPeriod period, DateTime? dateEnds)
    {
    ...
    public static Int32[] TimesheetFullSchedule(ILegallyPeriod period, Int32[] weekSchedule)
    {
    ...
    private static Int32 SecondsFromPeriodWeekSchedule(ILegallyPeriod period, Int32[] weekSchedule, int dayOrdinal)
    {
        int periodBeginCwd = WeekDayOfMonth(period, 1);
