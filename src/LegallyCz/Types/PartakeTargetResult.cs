...
public class PartakeHealthTarget
{
    ...
    public PartakeHealthTarget(Int16 contractCode, WorkTaxingTerms subjectType, Int16 interestCode, WorkHealthTerms subjectTerm, Int16 partakeCode, Int32 targetsBase)
    {
...
public record PartakeHealthResult(Int16 ContractCode, WorkTaxingTerms SubjectType, Int16 InterestCode, WorkHealthTerms SubjectTerm, Int16 PartakeCode, Int32 TargetsBase, Int32 ResultsBase);
public class PartakeSocialTarget
{
    ...
    public Int16 PartakeCode { get; private set; }
    public Int32 TargetsBase { get; private set; }
    public PartakeSocialTarget(Int16 contractCode, WorkTaxingTerms subjectType, Int16 interestCode, WorkSocialTerms subjectTerm, Int16 partakeCode, Int32 targetsBase)
    {
        this.ContractCode = contractCode;
        this.SubjectType = subjectType;
        this.InterestCode = interestCode;
...
public record PartakeSocialResult(Int16 ContractCode, WorkTaxingTerms SubjectType, Int16 InterestCode, WorkSocialTerms SubjectTerm, Int16 PartakeCode, Int32 TargetsBase, Int32 ResultsBase);
